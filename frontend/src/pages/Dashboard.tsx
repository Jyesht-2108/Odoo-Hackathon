...
import { Users, Briefcase, CalendarCheck, TrendingUp, MoreHorizontal } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Welcome back, Jyesht. Here's what's happening today.</p>
        </div>
        <div className="flex gap-3">
          <button className="btn btn-outline px-4 py-2">Download Report</button>
          <button className="btn btn-primary px-4 py-2">Add Employee</button>
        </div>
      </div>
        ...
        <div className="card p-6 lg:col-span-2">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Employee growth over the last 6 months</p>
            </div>
